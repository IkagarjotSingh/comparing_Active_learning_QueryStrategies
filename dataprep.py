...
#python3 dataprep.py -i "/data/raw/Firefox" -o "/data/preprocessed/firefox_data_class.csv"
...
def main():
    ...
    #rqmt_combinations['Label'] = rqmt_combinations['BinaryClass']
    ...
    rqmt_combinations = rqmt_combinations[rqmt_combinations['Label'] != 2]
